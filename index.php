...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Conatct Us</a>

                    </li>
                </ul>
                
                <a href="register.php"><button type="button" class="btn btn-light">Daftar</button></a>
                <a href="login.php"><button type="button" class="btn btn-danger ">Masuk</button></a>
    ...
    <div class="jumbotron">
        <section class="title">
            <p class="display-4 text-normal">Produk Kecantikan & Kesehatan</p>
            <p class="display-4 text-bold">BPOM dan Halal</p>
        </section>  
        ...
        <form class="cari" action="">
            ...
            <button type="button" class="fa fa-search btn btn-danger "></button>
        </form>
