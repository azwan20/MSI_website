...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" style="display: flex;"> <img src="img/msi.jpg" width="100" height="40" alt=""> 
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="#">Produk Kesehatan</a></li>
                            <li>
                ...
                <div class="col-sm-6 offset-md-3 text-left">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-group" name="jenis">
                                <option value="Perwatan Wajah">Perwatan Wajah</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-group" name="produk">
                                <option value="Sabun">Sabun Bambo</option>
                                <option value="serum">Serum Glowing</option>
                                <option value="misk">Face Misk Diamond</option>
                                <option value="peket">Paket</option>
                                <option value="manjavikan">Manjavikan</option>
                                <option value="Bodylotion">Bodylotion</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="tempat">Alamat Lengkap</label>
            ...
            <div class="col-sm-6 text-center">
                ...
                <div class="col-sm-6 text-center">
                    <p>Produk MSI adalah produk perawatan dan kesehatan yang dapat di gunakan untuk semua kalangan baik anak-anak hingga dewasa.
                        ...
                        izin Badan Pengawas Makanan dan Obat-obatan (BPOM).
                    </p>
                </div>
        </div>
    </section>
